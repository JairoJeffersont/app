...
$busca = $agendaTipoController->listarAgendaTipos($_SESSION['usuario_cliente']);
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid p-2">
            ...
            <div class="card mb-2 card-description">
                <div class="card-header bg-primary text-white px-2 py-1 card-background"><i class="bi bi-newspaper"></i> Adicionar Tipo de Agenda</div>
                <div class="card-body p-2">
                    <p class="card-text mb-2">Nesta seção, é possível adicionar e editar os tipos de agenda, garantindo a organização correta dessas informações no sistema.</p>
                ...
                <div class="card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $dados = [
                            ...
                            'agenda_tipo_cliente' => $_SESSION['usuario_cliente'],
                        ];

                        $result = $agendaTipoController->criarAgendaTipo($dados);
                            ...
                            <tbody>
                                ...
                                if ($busca['status'] == 'success') {
                                    foreach ($busca['dados'] as $agendaTipo) {
                                        ...
                                        echo '<td style="white-space: nowrap;">' . $agendaTipo['usuario_nome'] . ' - ' . date('d/m', strtotime($agendaTipo['agenda_tipo_criado_em'])) . '</td>';
                                        echo '</tr>';
                                    }
