...
$busca = $postagemStatusController->listarPostagensStatus($_SESSION['usuario_cliente']);
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid p-2">
            ...
            <div class="card mb-2 card-description">
                <div class="card-header bg-primary text-white px-2 py-1 card-background"><i class="bi bi-stickies"></i> Adicionar Status de Postagem</div>
                <div class="card-body p-2">
                    <p class="card-text mb-2">Nesta seção, é possível adicionar e editar os status de postagem, garantindo a organização correta dessas informações no sistema.</p>
                ...
                <div class="card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $dados = [
                            ...
                            'postagem_status_cliente' => $_SESSION['usuario_cliente'],
                        ];

                        $result = $postagemStatusController->criarPostagemStatus($dados);
                            ...
                            <tbody>
                                ...
                                if ($busca['status'] == 'success') {
                                    foreach ($busca['dados'] as $postagemStatus) {
                                        echo '<tr>';
                                        echo '<td style="white-space: nowrap;"><a href="?secao=status-postagem&id=' . $postagemStatus['postagem_status_id'] . '">' . $postagemStatus['postagem_status_nome'] . '</a></td>';
                                        echo '<td style="white-space: nowrap;">' . $postagemStatus['postagem_status_descricao'] . '</td>';
                                        echo '<td style="white-space: nowrap;">' . $postagemStatus['usuario_nome'] . ' - ' . date('d/m', strtotime($postagemStatus['postagem_status_criado_em'])) . '</td>';
                                        echo '</tr>';
                                    }
