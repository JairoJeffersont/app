...
if ($buscaClipping['status'] == 'not_found' || is_integer($clippingGet) || $buscaClipping['status'] == 'error') {
        ...
        <div class="container-fluid p-2">
            <div class="card mb-2 ">
                <div class="card-body p-1">
                    ...
                    <a class="btn btn-success btn-sm custom-nav card-description" href="?secao=clippings" role="button"><i class="bi bi-arrow-left"></i> Voltar</a>
                ...
                <div class="card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_atualizar'])) {
                        ...
                        $clipping = [
                            ...
                            'clipping_cliente' => $_SESSION['usuario_cliente']
                        ];
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST" enctype="multipart/form-data">
                        <div class="col-md-2 col-12">
                            <input type="url" class="form-control form-control-sm" name="clipping_link" placeholder="Link (http://...)" value="<?php echo $buscaClipping['dados'][0]['clipping_link'] ?>" required>
                        </div>
                        <div class="col-md-2 col-12">
                            <input type="text" class="form-control form-control-sm" name="clipping_titulo" placeholder="Titulo" value="<?php echo $buscaClipping['dados'][0]['clipping_titulo'] ?>" required>
                        </div>
                        <div class="col-md-1 col-12">
                            <input type="date" class="form-control form-control-sm" name="clipping_data" value="<?php echo $buscaClipping['dados'][0]['clipping_data'] ?>" placeholder="Data" required>
                        </div>
                        <div class="col-md-2 col-12">
                            <select class="form-select form-select-sm" name="clipping_orgao" id="orgao" required>
                                ...
                                if ($buscaOrgaos['status'] == 'success') {
                                    foreach ($buscaOrgaos['dados'] as $orgaos) {
                                        if ($orgaos['orgao_id'] == $buscaClipping['dados'][0]['clipping_orgao']) {
                        ...
                        <div class="col-md-2 col-12">
                            <select class="form-select form-select-sm" name="clipping_tipo" id="clipping_tipo" required>
                                <?php
                                $buscaTipos = $clippingTipoController->ListarClippingTipos($_SESSION['usuario_cliente']);
                                if ($buscaTipos['status'] == 'success') {
                                    foreach ($buscaTipos['dados'] as $tipos) {
                                        if ($tipos['clipping_tipo_id'] == $buscaClipping['dados'][0]['clipping_tipo']) {
                        ...
                        <div class="col-md-12 col-12">
                            <textarea class="form-control form-control-sm" name="clipping_resumo" rows="10" placeholder="Texto do clipping" required><?php echo $buscaClipping['dados'][0]['clipping_resumo'] ?></textarea>
                        </div>
                        <div class="col-md-2 col-12">
            ...
            <div class="card shadow-sm mb-2">
                <div class="card-body p-2">
                    <?php
                    $arquivo = $buscaClipping['dados'][0]['clipping_arquivo'];
