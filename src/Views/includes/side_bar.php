<div class="border-end bg-white" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a class="list-group-item list-group-item-action list-group-item-light px-4" href="?secao=estatisticas&estado=<?php echo $_SESSION['cliente_deputado_estado'] ?>"><i class="bi bi-graph-up"></i> Estatísticas</a>
