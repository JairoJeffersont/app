...
$busca = $proposicaoTemaController->listarProposicoesTemas($_SESSION['usuario_cliente']);
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid p-2">
            ...
            <div class="card mb-2 card-description">
                <div class="card-header bg-primary text-white px-2 py-1 card-background"><i class="bi bi-people-fill"></i> Adicionar Proposição de Tema</div>
                ...
                <div class="card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $dados = [
                            ...
                            'proposicao_tema_cliente' => $_SESSION['usuario_cliente'],
                        ];
