...
$busca = $documentoTipoController->listarDocumentosTipos($_SESSION['usuario_cliente']);
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid p-2">
            ...
            <div class="card mb-2 card-description">
                <div class="card-header bg-primary text-white px-2 py-1 card-background"><i class="bi bi-file-earmark-text-fill"></i> Adicionar Tipo de Documento</div>
                <div class="card-body p-2">
                    <p class="card-text mb-2">Nesta seção, é possível adicionar e editar os tipos de documentos, garantindo a organização correta dessas informações no sistema.</p>
                ...
                <div class="card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $dados = [
                            ...
                            'documento_tipo_cliente' => $_SESSION['usuario_cliente'],
                        ];

                        $result = $documentoTipoController->criarDocumentoTipo($dados);

                        // Exibição de mensagem de retorno
                            ...
                            <tbody>
                                ...
                                if ($busca['status'] == 'success') {
                                    foreach ($busca['dados'] as $documentoTipo) {
                                        echo '<tr>';
                                        echo '<td style="white-space: nowrap;"><a href="?secao=tipo-documento&id=' . $documentoTipo['documento_tipo_id'] . '">' . $documentoTipo['documento_tipo_nome'] . '</a></td>';
                                        echo '<td style="white-space: nowrap;">' . $documentoTipo['documento_tipo_descricao'] . '</td>';
                                        echo '<td style="white-space: nowrap;">' . $documentoTipo['usuario_nome'] . ' - ' . date('d/m', strtotime($documentoTipo['documento_tipo_criado_em'])) . '</td>';
                                        echo '</tr>';
                                    }
